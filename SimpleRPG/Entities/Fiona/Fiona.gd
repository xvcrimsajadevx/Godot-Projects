		...
		QuestStatus.NOT_STARTED:
			match dialogue_state:
				0:
					...
					# Show dialogue popup
					dialoguePopup.dialogue = "Hello adventurer! I lost my necklace, can you please find it for me?"
		...
		QuestStatus.STARTED:
			match dialogue_state:
				...
				2:
					...
					yield(get_tree().create_timer(0.5), "timeout") # Delay added in case advancement panel appears
